...
def ScreenBlit(draw_image, x_position, y_position):
    # screen.blit(이미지, (x좌표, y좌표))
    screen.blit(draw_image, (x_position, y_position))
...
while running:
    ...
    ScreenBlit(background, (0, 0)) # 배경 화면
    ScreenBlit(character, (character_x_pos, character_y_pos)) # 캐릭터 (0, 가운데)
    ScreenBlit(enemy, (enemy_x_pos, enemy_y_pos)) # 적 (랜덤, 0)
