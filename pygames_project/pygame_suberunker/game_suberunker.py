...
ddong_x_pos = random.randint(0, screen_width - ddong_width) # randint(시작, 끝) 0, screen_width : 좌우 끝
ddong_y_pos = 0
...
while running:
    ...
    screen.blit(character, (character_x_pos, ddong_y_pos))
