...
gameover = pygame.image.load("resources/images/gameover.png") # 게임 패배
youwin = pygame.image.load("resources/images/youwin.png")     # 게임 승리

# 3.1 - Load audio - 효과음 추가
...
while running:
    ...
    for badguy in badguys:
        ...
        if badrect.left<64:
            ...
            badguys.pop(index)
        #6.3.2 - Check for collisions - 화살, 오소리 충돌 체크
        index1=0
        for bullet in arrows:
            bullrect=pygame.Rect(arrow.get_rect())
            bullrect.left=bullet[1]
            bullrect.top=bullet[2]
            if badrect.colliderect(bullrect): # pygame 내장 함수 -colliderect()
                enemy.play() # 효과음
                acc[0]+=1
                badguys.pop(index)
                arrows.pop(index1)
    ...
    # 6.4 - Draw clock - 시계
    font = pygame.font.Font(None, 24) # 원하는 플레이 시간-pygame.time.get_ticks
